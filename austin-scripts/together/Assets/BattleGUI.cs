		 ...
		 */
			...
			if (!attackLock) {
				...
				if (transitions.currBattle == "wakeup") { //This is actually our first wake up battle here
						...
						spec1 = "Sip Coffee";
						spec2 = "Cold Shower";
						DescriptionBox.ATTACK_DESC = "Shut off that alarm! Deals damage based on happiness.";
						DescriptionBox.DIE_DESC = "Invigorate yourself with a cuppa joe. Deals MODERATE damage based on happiness to a single target.\nRequires a grade of " + TurnStateMachine.DIE_MANA_COST + ".";
			DescriptionBox.SPLOSIONS_DESC = "An icy shower strikes down lethargy. Deals HIGH damage based on happiness to ALL enemies.\nRequires a grade of " + TurnStateMachine.SPLOSIONS_MANA_COST + ".";
				...
				if (transitions.currBattle == "lecture") {
						...
						spec1 = "More Coffee";
						spec2 = "Raise hand";
			DescriptionBox.ATTACK_DESC = "Scribble down some notes. Deals damage based on happiness.";
			DescriptionBox.DIE_DESC = "A double-whip, low-fat, soy, mocha frappa-lappa-chino. Deals MODERATE damage based on happiness to a single target.\nRequires a grade of " + TurnStateMachine.DIE_MANA_COST + ".";
			DescriptionBox.SPLOSIONS_DESC = "Break the awkward silence by being the one to answer the professor's question. Deals HIGH damage based on happiness to ALL enemies.\nRequires a grade of " + TurnStateMachine.SPLOSIONS_MANA_COST + ".";
				...
				if (transitions.currBattle == "test") {
						...
						spec2 = "Cheat Sheet";
			DescriptionBox.ATTACK_DESC = "Tackle the problem at hand. Deals damage based on happiness.";
			DescriptionBox.DIE_DESC = "Solve the bonus question for extra credit. Deals MODERATE damage based on happiness to a single target.\nRequires a grade of " + TurnStateMachine.DIE_MANA_COST + ".";
			DescriptionBox.SPLOSIONS_DESC = "Whip out your meticulously prepared cheat sheet. Deals HIGH damage based on happiness to ALL enemies.\nRequires a grade of " + TurnStateMachine.SPLOSIONS_MANA_COST + ".";
			...
			DescriptionBox.ATTACK_DESC = "Throw your weight into it! Deals damage based on happiness.";
			DescriptionBox.DIE_DESC = "Hydrate yourself with a cool drink. Deals MODERATE damage based on happiness to a single target.\nRequires a grade of " + TurnStateMachine.DIE_MANA_COST + ".";
			DescriptionBox.SPLOSIONS_DESC = "Make heads turn with how fabulous you are. Deals HIGH damage based on happiness to ALL enemies.\nRequires a grade of " + TurnStateMachine.SPLOSIONS_MANA_COST + ".";
			...
			DescriptionBox.ATTACK_DESC = "Go ahead, take a bite. Deals damage based on happiness.";
			DescriptionBox.DIE_DESC = "Treat yo' self. Deals MODERATE damage based on happiness to a single target.\nRequires a grade of " + TurnStateMachine.DIE_MANA_COST + ".";
			DescriptionBox.SPLOSIONS_DESC = "Your body needs food, and it gives you the energy you need. Deals HIGH damage based on happiness to ALL enemies.\nRequires a grade of " + TurnStateMachine.SPLOSIONS_MANA_COST + ".";
				...
				if (transitions.currBattle == "studying") {
						...
						spec1 = "Study Buddy";
						spec2 = "Highlight";
			DescriptionBox.ATTACK_DESC = "Flick the page to the next section. Progress! Deals damage based on happiness.";
			DescriptionBox.DIE_DESC = "Grab a friend who helps you through a tough subject. Deals MODERATE damage based on happiness to a single target.\nRequires a grade of " + TurnStateMachine.DIE_MANA_COST + ".";
			DescriptionBox.SPLOSIONS_DESC = "Good thing you bought that pack of 20 different colored highlighters. Deals HIGH damage based on happiness to ALL enemies.\nRequires a grade of " + TurnStateMachine.SPLOSIONS_MANA_COST + ".";
				...
				if (transitions.currBattle == "club") {
						...
						spec2 = "RAINBOWS";
			DescriptionBox.ATTACK_DESC = "Do a bit of mingling. Deals damage based on happiness.";
			DescriptionBox.DIE_DESC = "Politely point out some problematic language. Deals MODERATE damage based on happiness to a single target.\nRequires a grade of " + TurnStateMachine.DIE_MANA_COST + ".";
			DescriptionBox.SPLOSIONS_DESC = "Flaunt your pride! Deals HIGH damage based on happiness to ALL enemies.\nRequires a grade of " + TurnStateMachine.SPLOSIONS_MANA_COST + ".";
				...
				if (transitions.currBattle == "friends") {
						...
						spec1 = "Criticism";
						spec2 = "Coming Out";
			DescriptionBox.ATTACK_DESC = "Make a sassy comeback to make everyone laugh. Deals damage based on happiness.";
			DescriptionBox.DIE_DESC = "Point out some insensitive language. Deals MODERATE damage based on happiness to a single target.\nRequires a grade of " + TurnStateMachine.DIE_MANA_COST + ".";
			DescriptionBox.SPLOSIONS_DESC = "You decide to come out so you can really be yourself around them. Deals HIGH damage based on happiness to ALL enemies.\nRequires a grade of " + TurnStateMachine.SPLOSIONS_MANA_COST + ".";
				...
				if (transitions.currBattle == "hw") {
						...
						spec1 = "Study Buddy";
						spec2 = "Extra Credit";
			DescriptionBox.ATTACK_DESC = "Solve that tricky homework problem. Deals damage based on happiness.";
			DescriptionBox.DIE_DESC = "Grab a friend who helps you through a tough subject. Deals MODERATE damage based on happiness to a single target.\nRequires a grade of " + TurnStateMachine.DIE_MANA_COST + ".";
			DescriptionBox.SPLOSIONS_DESC = "Spend a little more time for a few more points. Deals HIGH damage based on happiness to ALL enemies.\nRequires a grade of " + TurnStateMachine.SPLOSIONS_MANA_COST + ".";
			...
			DescriptionBox.ATTACK_DESC = "Break out those killer dance moves! Deals damage based on happiness.";
			DescriptionBox.DIE_DESC = "Someone insults your fashion choices, and you SHUT THEM DOWN. Deals MODERATE damage based on happiness to a single target.\nRequires a grade of " + TurnStateMachine.DIE_MANA_COST + ".";
			DescriptionBox.SPLOSIONS_DESC = "Make everyone re-question their notion of the gender binary. Deals HIGH damage based on happiness to ALL enemies.\nRequires a grade of " + TurnStateMachine.SPLOSIONS_MANA_COST + ".";
			...
			DescriptionBox.ATTACK_DESC = "Throw down the pillows and get yourself settled in. Deals damage based on happiness.";
			DescriptionBox.DIE_DESC = "Bring in a little light and make the room smell nice too. Deals MODERATE damage based on happiness to a single target.\nRequires a grade of " + TurnStateMachine.DIE_MANA_COST + ".";
			DescriptionBox.SPLOSIONS_DESC = "Music, white noise, whatever helps you sleep. Deals HIGH damage based on happiness to ALL enemies.\nRequires a grade of " + TurnStateMachine.SPLOSIONS_MANA_COST + ".";
